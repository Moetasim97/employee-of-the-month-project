...
urlpatterns = [
    ...
    path('return_employee/<int:user_id>/',
         views.return_employee, name='return_employee'),
    path('update_eotm_interactions/', views.record_interaction,
         name='updated_interactions'),
